...
-- 6 --
SELECT AVG(rating) FROM analytics GROUP BY category ORDER BY AVG(rating);
...
-- 15 --
SELECT app_name,reviews,min_installs/reviews AS proportion FROM analytics WHERE min_installs>100,000 ORDER BY proportion DESC LIMIT 1; 